...
def render():
    ...
    for frame_index, rows in enumerate(frames):
        svg.append(f'<g opacity="0"><animate attributeName="opacity" values="0;1;1;0;0" keyTimes="0;.04;.30;.34;1" dur="9s" begin="-{frame_index * 3}s" repeatCount="indefinite"/>')
    ...
    print("rendered three portrait frames; each displays for about 3 seconds")
